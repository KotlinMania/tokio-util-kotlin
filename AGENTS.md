...
This file is the quick-reference operating contract for tokio-util-kotlin. The longer
...
tokio-util-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tokio-util`](https://crates.io/crates/tokio-util). Upstream Rust is the behavioral oracle while the
