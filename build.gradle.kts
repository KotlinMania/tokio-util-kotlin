...
kotlin {
    ...
    android {
        namespace = "io.github.kotlinmania.tokioutil"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tokio-util-kotlin", version.toString())

    pom {
        name.set("tokio-util-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/tokio - Additional utilities for working with Tokio")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tokio-util-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tokio-util-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tokio-util-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tokio-util-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTokioUtilXCFramework",
    "assembleTokioUtilDebugXCFramework",
    "assembleTokioUtilReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseIosFatFrameworkForTokioUtilXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTokioUtilXCFramework",
    "assembleDebugMacosFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseMacosFatFrameworkForTokioUtilXCFramework",
    "assembleDebugTvosFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseTvosFatFrameworkForTokioUtilXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTokioUtilXCFramework",
    "assembleDebugWatchosFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseWatchosFatFrameworkForTokioUtilXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTokioUtilXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTokioUtilXCFramework",
