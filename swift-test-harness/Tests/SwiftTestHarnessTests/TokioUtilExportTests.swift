...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TokioUtil.swiftmodule/`
...
//      `import TokioUtil` above would fail at compile time.
//
//   2. The static archive `libTokioUtil.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TokioUtil" }` and
//      `flattenPackage = "io.github.kotlinmania.tokioutil"` configuration in
...
//      via the `TokioUtilLibrary` product.
//
...
final class TokioUtilExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "TokioUtil swift module imported cleanly")
    }
}
