# tokio-util-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Ftokio--util--kotlin-blue.svg)](https://github.com/KotlinMania/tokio-util-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/tokio-util-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/tokio-util-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/tokio-util-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/tokio-util-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`tokio-rs/tokio`](https://github.com/tokio-rs/tokio).

**Original Project:** This port is based on [`tokio-rs/tokio`](https://github.com/tokio-rs/tokio). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
> The text below is reproduced and lightly edited from [`https://github.com/tokio-rs/tokio`](https://github.com/tokio-rs/tokio). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
This Kotlin port is distributed under the same MIT license as the upstream [`tokio-rs/tokio`](https://github.com/tokio-rs/tokio). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`tokio-rs/tokio`](https://github.com/tokio-rs/tokio) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
